...
def readAllDepth(city,path,landuse,dt):
    ...
    colname =['Time', 'qingA', 'zA', 'zhongA', 'qingR', 'zr', 'zhongR', 'volume', 'cropA', 'cropR', 'bdA', 'bdR', 'trafficA', 'trafiicR', 'affectedPeople']
            ...
            for row in range(rows):
                for col in range(cols):
                    ...
                    if depthvalue > 0.01:
                        ...
                        #count landusetype 
            # Preapare data
            output1 = [ctime,qingA,zA,zhongA, qingA/allarea, zA/allarea, zhongA/allarea, volume, cropA, cropA / croptotal, bdA, bdA/bdtotal, trafficA, trafficA/traffictotal,affectedPeople]
